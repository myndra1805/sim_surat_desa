...
<body>
    ...
    <section>
        <p>
            Benar yang tersebut namanya di atas adalah penduduk Gampong Seuleumbah, Kecamatan Jeumpa, Kabupaten Bireuen.
            Berdasarkan catatan yang ada serta sepengetahuan kami dan ianya :
        </p>
        <ol>
            <li>Berkelakuan Baik, tidak pernah melakukan tindakan/ perbuatan yang menyimpang atau norma sosial yang
                berlaku</li>
        ...
        <p>
            Demikian surat keterangan Berkelakuan Baik ini dikeluarkan dengan sebenarnya untuk dapat dipergunakan
            seperlunya.
        </p>
    </section>
